      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-2">
            ...
            <span className="text-white dark:text-white text-gray-900 font-semibold text-xl hidden sm:block">
              ...
              <Link
                ...
                className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${
                  isActive(item.to)
                    ...
                    : "text-gray-300 dark:text-gray-300 text-gray-900 hover:text-white hover:bg-dark-700 dark:hover:bg-dark-700 hover:bg-gray-200"
                }`}
              >
                {item.name}
              </Link>
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="relative w-10 h-10 rounded-lg flex items-center justify-center bg-dark-700 dark:bg-dark-700 bg-gray-200 hover:bg-dark-600 dark:hover:bg-dark-600 hover:bg-gray-300 transition-colors duration-300 group"
            >
              {/* Luna (oscuro) */}
              <span
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
              >
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-2.277-6.264-6.086-6.264-2.445 0-4.164 1.874-4.164 4.272v4.496h-3v11h3v-7.125c.815-1.437 2.616-2.375 4.414-2.375 1.141 0 2.086.257 2.662.676v4.824z" />
              </svg>
            </a>
          </div>
        </div>
