...
const menuItems = [
  ...
  { name: "Persona", path: "/admin/persona", icon: "person" },
  { name: "Estudios", path: "/admin/estudios", icon: "school" },
  { name: "Experiencia Laboral", path: "/admin/explaboral", icon: "work" },
  { name: "Actividad Docente", path: "/admin/actdocente", icon: "teaching" },
  { name: "Congresos", path: "/admin/congresos", icon: "event" },
  { name: "Hard Skills", path: "/admin/hardskills", icon: "skills" },
  { name: "Proyectos", path: "/admin/proyectos", icon: "folder" },
];
          ...
          <div className="p-6 border-b border-dark-700">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-brand-violet capitalize">{user?.rol}</p>
              </div>
            </div>
          </div>
